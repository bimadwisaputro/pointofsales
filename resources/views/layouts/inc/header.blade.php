...
<head>
    ...
    <link href="{{ asset('assets/adminlte/assets/img/apple-touch-icon.png') }}" rel="apple-touch-icon">
    ...
    <header id="header" class="header fixed-top d-flex align-items-center">
        ...
        <div class="d-flex align-items-center justify-content-between">
            <a href="index.html" class="logo d-flex align-items-center">
                <img src="{{ asset('assets/adminlte/assets/img/logo.png') }}" alt="">
            ...
            <ul class="d-flex align-items-center">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow messages">
                        ...
                        <li class="message-item">
                            <a href="#">
                                <img src="{{ asset('assets/adminlte/assets/img/messages-1.jpg') }}" alt=""
                        ...
                        <li class="message-item">
                            <a href="#">
                                <img src="{{ asset('assets/adminlte/assets/img/messages-2.jpg') }}" alt=""
                                    class="rounded-circle">
                                <div>
                                    <h4>Anna Nelson</h4>
                                    <p>Velit asperiores et ducimus soluta repudiandae labore officia est ut...</p>
                        ...
                        <li class="message-item">
                            <a href="#">
                                <img src="{{ asset('assets/adminlte/assets/img/messages-3.jpg') }}" alt=""
                                    class="rounded-circle">
                                <div>
                                    <h4>David Muldon</h4>
                                    <p>Velit asperiores et ducimus soluta repudiandae labore officia est ut...</p>
                ...
                <li class="nav-item dropdown pe-3">
                    ...
                    <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#"
                        ...
                        <img src="{{ asset('assets/adminlte/assets/img/profile-img.jpg') }}" alt="Profile"
                            class="rounded-circle">
